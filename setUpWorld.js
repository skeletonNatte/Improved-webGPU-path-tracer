...
const NUM_TRIANGLES = TRIANGLES.length / 16;
...
const NUM_BOUNDING_BOXES = AABBS.length / 12;

MATERIALS = MATERIALS.flat();
MATERIALS = new Float32Array(MATERIALS);
const NUM_MATERIALS = MATERIALS.length / 8;
